...
namespace BTL_QuanLiKTX
{
	public partial class FormTKHoaDon : Form
	{
		...
		{
			// TODO: This line of code loads data into the 'nhan.Thuephong' table. You can move, or remove it, as needed.
			this.thuephongTableAdapter.Fill(this.nhan.Thuephong);
